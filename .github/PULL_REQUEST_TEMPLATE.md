...
- [ ] I have read the [CONTRIBUTING](https://github.com/LinuxBeginnings/Arch-Hyprland/blob/main/CONTRIBUTING.md) document.
- [ ] My code follows the code style of this project.
- [ ] My commit message follows the [commit guidelines](https://github.com/LinuxBeginnings/Arch-Hyprland/blob/main/CONTRIBUTING.md#git-commit-messages).
